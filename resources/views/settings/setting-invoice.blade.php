                                    ...
                                    <div class="d-flex align-items-center me-2">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-5">
                                                ...
                                                <br>
                                                <select class="form-select form-select-solid" name="template" id="invoiceTemplateId" data-control="select2">
                                                    @foreach($invoiceTemplate as $template)
                                                        <option value="{{ $template['key'] }}" data-color="{{ $template['template_color'] }}">{{$template['template_name']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-lg-12 mb-5">
