<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::select('category_id', $categories ,null, ['id'=>'categoryId', 'class' => 'form-select io-select2 form-select-solid', 'placeholder' => 'Select Category', 'required', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
