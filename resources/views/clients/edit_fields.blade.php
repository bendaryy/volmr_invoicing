<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::tel('contact', $client->user->contact ?? null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Phone number', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::select('country_id', $countries, $client->country_id ?? null, ['id'=>'countryId','class' => 'form-select io-select2 form-select-solid','placeholder' => 'Select Country', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
            {{ Form::label('state', __('messages.client.state').':', ['class' => 'form-label mb-3']) }}
            {{ Form::select('state_id', [], null, ['id'=>'stateId','class' => 'form-select io-select2 form-select-solid','placeholder' => 'Select State', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
            {{ Form::label('city', __('messages.client.city').':', ['class' => 'form-label mb-3']) }}
            {{ Form::select('city_id', [], null, ['id'=>'cityId','class' => 'form-select io-select2 form-select-solid','placeholder' => 'Select City', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
