        ...
        <div class="d-flex align-items-center flex-equal fw-row me-4 order-2">
            <div class="">
                @if($invoice->status == \App\Models\Invoice::DRAFT)
                    ...
                    {{ Form::select('client_id', $clients, $client_id ?? null, ['class' => 'form-select io-select2', 'id' => 'client_id', 'placeholder' => 'Select Client','required', 'data-control' =>'select2']) }}
                @else
...
{{--                    <input type="hidden" value="{{$invoice->client->user->id}}" name="client_id">--}}
{{--                @endif--}}
{{--            </div>--}}
{{--        </div>--}}
