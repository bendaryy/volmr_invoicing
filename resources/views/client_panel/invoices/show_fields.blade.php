...
{{--                                   id="tblInvoicePaymentHistory">--}}
{{--                                <thead>--}}
{{--                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">--}}
{{--                                    <th>{{ __('messages.payment.payment_date') }}</th>--}}
{{--                                    <th>{{ __('messages.invoice.paid_amount') }}</th>--}}
{{--                                    <th>{{ __('messages.payment.payment_mode') }}</th>--}}
{{--                                </tr>--}}
{{--                                </thead>--}}
...
{{--                                        <td>{{ getCurrencySymbol() }}&nbsp;{{ numberFormat($payment->amount) }}</td>--}}
{{--                                        <td>--}}
{{--                                            @if($payment->payment_mode == \App\Models\Payment::MANUAL)--}}
{{--                                                <span class="badge badge-light-warning fs-7">{{ $payment->payments_mode }}</span>--}}
{{--                                            @elseif($payment->payment_mode == \App\Models\Payment::STRIPE)--}}
{{--                                                <span class="badge badge-light-success fs-7">{{ $payment->payments_mode }}</span>--}}
{{--                                            @elseif($payment->payment_mode == \App\Models\Payment::PAYPAL)--}}
{{--                                                <span class="badge badge-light-primary fs-7">{{ $payment->payments_mode }}</span>--}}
{{--                                            @elseif($payment->payment_mode == \App\Models\Payment::CASH)--}}
{{--                                                <span class="badge badge-light-info fs-7">{{ $payment->payments_mode }}</span>--}}
{{--                                            @elseif($payment->payment_mode == \App\Models\Payment::RAZORPAY)--}}
{{--                                                <span class="badge badge-light-danger fs-7">{{ $payment->payments_mode }}</span>--}}
{{--                                            @endif--}}
{{--                                        </td>--}}
{{--                                    </tr>--}}
{{--                                @endforeach--}}
