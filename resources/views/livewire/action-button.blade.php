...
@if(isset($value['edit-route']))
    <a href="{{ $value['edit-route'] }}" class="btn px-2 text-primary fs-3 py-2" data-bs-toggle="tooltip" title="{{__('messages.common.edit')}}">
        <i class="fa-solid fa-pen-to-square"></i>
    </a>
@endif
<a href="javascript:void(0)" data-id="{{ $value['data-id'] }}" class="delete-btn btn px-2 text-danger fs-3 py-2" title="{{__('messages.common.delete')}}"
