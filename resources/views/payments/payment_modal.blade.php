            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4 mb-5 ">
                        ...
                        <div class="input-group">
                            ...
                            <a class="input-group-text bg-secondary border-0 text-decoration-none" id="autoCode" href="javascript:void(0)"
                               data-toggle="tooltip"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4 mb-5 ">
                        ...
                        <div class="input-group">
                            {{ Form::number('amount', null, ['id'=>'amount','class' => 'form-control form-control-solid amount d-flex','step'=>'any','oninput'=>"validity.valid||(value=value.replace(/[e\+\-]/gi,''))",'min'=>'0','pattern'=>"^\d*(\.\d{0,2})?$",'required','placeholder'=>'Enter Amount']) }}
