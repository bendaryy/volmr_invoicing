            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                       ...
                       {{ Form::number('value', null, ['id'=>'value','class' => 'form-control form-control-solid','value'=>'0', 'required','placeholder' => 'Tax Value']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
...
{{--                        {{ Form::number('value', null, ['id'=>'value','class' => 'form-control form-control-solid','oninput'=>"validity.valid||(value=value.replace(/[e\+\-]/gi,''))",'min'=>'0','value'=>'0','step'=>'.01', 'required']) }}--}}
{{--                    </div>--}}
{{--                    <div class="form-group col-sm-12 mb-5">--}}
