...
{{--                        {{ Form::text('name', null, ['id'=>'editTaxName','class' => 'form-control form-control-solid', 'required']) }}--}}
{{--                    </div>--}}
{{--                    <div class="form-group col-sm-12 mb-5">--}}
{{--                        {{ Form::label('value', __('messages.common.value').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}--}}
{{--                        {{ Form::number('value', null, ['id'=>'editTaxValue','class' => 'form-control form-control-solid', 'min' => 0,'oninput'=>"validity.valid||(value=value.replace(/[e\+\-]/gi,''))",'min'=>'0','value'=>'0','step'=>'.01','required']) }}--}}
{{--                    </div>--}}
{{--                    <div class="form-group col-sm-12 mb-5">--}}
