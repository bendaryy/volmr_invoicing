...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('admin/category*') ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('admin/category*') ? 'active' : '' }}"
...
@else
    ...
    <li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('admin/settings*', 'admin/currencies*', 'admin/payment-gateway*')) ? 'd-none' : '' }}">
