...
Route::group(['prefix' => 'admin', 'middleware' => ['auth','xss','role:admin']], function () {
    ...
    Route::get('clients/{client}/{isActive?}', [ClientController::class, 'show'])->name('clients.show');
    ...
    //getInvoiceDueAmount
    Route::get('payments.get-invoiceAmount/{id}', [AdminPaymentController::class, 'getInvoiceDueAmount'])->name('payments.get-invoiceAmount');
...
Route::group(['prefix' => 'client', 'middleware' => ['auth','xss','role:client']], function () {
    ...
    Route::get('invoices/{invoice}/pdf', [Client\InvoiceController::class, 'convertToPdf'])->name('clients.invoices.pdf');
    //export Excel file
